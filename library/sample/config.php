...
Redux::set_section($opt_name, array (
   ...
   'fields' => array(
       ...
       array(
           'id' => 'header-logo-switch-button',
           'type' => 'switch',
           'title' => __('Enter your header logo', 'FA'),
           'subtitle' => __('You can header logo any kinds', 'FA'),
           'desc' => __('This is header logo area', 'FA'),
           'default' => true
       ),
       array(
           'id' => 'iklan-logo-switch-button',
           'type' => 'switch',
           'title' => __('Enter your header logo', 'FA'),
           'subtitle' => __('You can header logo any kinds', 'FA'),
           'desc' => __('This is header logo area', 'FA'),
       ...
       array(
           'id' => 'header-logo',
           'type' => 'media',
           'title' => __('Enter your add', 'FA'),
           'subtitle' => __('You can upload any kinds of add', 'FA'),
           'desc' => __('Size: 400x200', 'FA'),
           'customizer_width' => '500px',
           'compiler' => true,
           'default' => array(
               'url' => get_template_directory_uri().'images/googleadd.png'
           )
        ),
       array(
           'id' => 'iklan-logo',
           'type' => 'media',
           'title' => __('Enter your advertisement', 'FA'),
           'subtitle' => __('You can upload any kinds of add', 'FA'),
           'desc' => __('Size: 850x200', 'FA'),
           'customizer_width' => '500px',
           'compiler' => true,
           'default' => array(
               'url' => get_template_directory_uri().'images/googleadd.png'
...
Redux::set_section($opt_name, array (
    ...
    'fields' => array(
        array(
            'id' => 'copyright-text',
            'type' => 'text',
            'title' => __('Enter your copyright text', 'FA'),
            'subtitle' => __('You can copyright text any kinds', 'FA'),
...
Redux::set_section($opt_name, array (
    'title' => __('Footer Background', 'FA'),
    'id' => 'color-footer',
    'subsection' => true,
    'desc' => __('This is footer background area', 'FA'),
    'icon' => __('dashicons dashicons-format-image', 'FA'),
    'fields' => array(
        array(
            'id' => 'footer-background',
            'type' => 'color',
            'title' => __('Enter your footer background color', 'FA'),
            'subtitle' => __('You can footer background color any kinds', 'FA'),
            'desc' => __('This is footer background color area', 'FA'),
            'default' => '#000000'
        ),
        ...
        array(
            ...
            'type' => 'color',
            'title' => __('Enter your footer font color', 'FA'),
            'subtitle' => __('You can footer font color any kinds', 'FA'),
            'desc' => __('This is footer font color area', 'FA'),
            'default' => '	#FFFFFF'
        )
    )
));
...
Redux::set_section($opt_name, array (
    'title' => __('Footer Switch Button', 'FA'),
    'id' => 'footer-switch-button',
    'subsection' => true,
    'desc' => __('This is switch button area', 'FA'),
    'icon' => __('dashicons dashicons-format-image', 'FA'),
    'fields' => array(
        array(
            'id' => 'footer-switch-button',
